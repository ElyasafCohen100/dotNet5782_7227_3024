...
namespace Dal
{
    partial class DalObject : DalApi.IDal
    {
        ...
        /// <summary>
        /// get the drone list (only the "isActive == true)
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns>list of relevant drones </returns>
        [MethodImpl(MethodImplOptions.Synchronized)]
        ...
        /// <summary>
        /// add DroneCharge to the DroneCharge List
        /// </summary>
        ...
        /// <summary>
        /// check if the droneCharge  is already exist
        /// </summary>
        /// <param name="droneId"></param>
